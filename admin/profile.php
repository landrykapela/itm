...
<p class="subtitle">Personal Info</p><a class="button primary-bg border-white-all round-corner" href="edit_profile.php?e='.$user['id'].'">Edit</a>
...
>
<div class="w-40  padding-std flex-column flex-top flex-middle  primary-bg white-text">
<p class="subtitle">Education Background</p><a class="button primary-bg border-white-all round-corner" href="edit_education.php?e='.$user['id'].'">Add</a>
...
>
<div class="w-40  padding-std flex-column flex-top flex-middle  primary-bg white-text">
<p class="subtitle">Professional Experience</p><a class="button primary-bg border-white-all round-corner" href="edit_work.php?e='.$user['id'].'">Add</a>
...
>
<div class="w-40  padding-std flex-column flex-top flex-middle  primary-bg white-text">
<p class="subtitle">Reference</p><a class="button primary-bg border-white-all round-corner" href="edit_reference.php?e='.$user['id'].'">Add</a>
